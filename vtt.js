...
(function(global) {
  ...
  // The position of a style box in a form that we can easily compute things like
  // overlaps and intersects with. Can initialize it with either a StyleBox
  // or another BoxPosition.
  function BoxPosition(obj) {
    ...
    this.overlapsAny = function(boxes) {
    ...
    this.within = function(container) {
    ...
    // box.
    this.intersectPercentage = function(b2) {
    ...
    // the reference containers positions. This has to be done because this
    // box's positions are in reference to the viewport origin, whereas, CSS
    // values are in referecne to their respective edges.
    this.toCSSCompatValues = function(reference) {
      return {
  ...
  // Get an object that represents the boxes position without anything extra.
  ...
  // passes is the increment at which it will move the box around. The containerBox
  ...
  function moveBoxToLinePosition(window, styleBox, lineHeight, containerBox, boxPositions) {
    ...
    // Passiong ["+x", "-x"] will move the box first along the x axis in the positive
